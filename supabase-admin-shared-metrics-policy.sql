-- Update RLS policy to allow all admins to see and manage all metrics data
-- This allows admins to view metrics entered by other admins
...
-- 2. Admins to manage ALL metrics (from any user)
